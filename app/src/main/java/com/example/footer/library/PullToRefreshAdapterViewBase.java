...
import com.example.footer.library.internal.EmptyViewMethodAccessor;
import com.example.footer.library.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
		...
		if (DEBUG) {
			LogUtil.d("First Visible: " + firstVisibleItem + ". Visible Count: " + visibleItemCount
	...
	private boolean isFirstItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			if (DEBUG) {
				LogUtil.d("isFirstItemVisible. Empty View.");
			}
			return true;
	...
	private boolean isLastItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			if (DEBUG) {
				LogUtil.d("isLastItemVisible. Empty View.");
			}
			return true;
		} else {
			...
			if (DEBUG) {
				LogUtil.d("isLastItemVisible. Last Item Position: " + lastItemPosition + " Last Visible Pos: "
						+ lastVisiblePosition);
			}
