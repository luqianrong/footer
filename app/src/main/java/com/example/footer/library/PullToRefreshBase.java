...
import com.example.footer.library.IPullToRefresh;
import com.example.footer.library.LoadingLayoutProxy;
import com.example.footer.library.OverscrollHelper;
import com.example.footer.library.internal.FlipLoadingLayout;
import com.example.footer.library.internal.LoadingLayout;
import com.example.footer.library.internal.RotateLoadingLayout;
import com.example.footer.library.internal.Utils;
import com.example.footer.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	public void addView(View child, int index, ViewGroup.LayoutParams params) {
		if (DEBUG) {
			LogUtil.d("addView: " + child.getClass().getSimpleName());
		}
	...
	public final void setMode(Mode mode) {
		if (mode != mMode) {
			if (DEBUG) {
				LogUtil.d("Setting mode to: " + mode);
			}
			mMode = mode;
			updateUIForMode();
		}
	...
	protected final void onSizeChanged(int w, int h, int oldw, int oldh) {
		if (DEBUG) {
			LogUtil.d( String.format("onSizeChanged. W: %d, H: %d", w, h));
		}
	...
	public final void setHeaderScroll(int value) {
		if (DEBUG) {
			LogUtil.d("setHeaderScroll: " + value);
		}
