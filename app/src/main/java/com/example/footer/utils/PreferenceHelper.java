...
public class PreferenceHelper {
    ...
    //Login_hb
    public static SharedPreferences getUserLogin(Context context){
        return context.getSharedPreferences("user",Context.MODE_PRIVATE);
    }

    public static SharedPreferences getUserStatus(Context context){
    ...
    public static SharedPreferences getJpushConfig(Context context){
        return context.getSharedPreferences("jpush",Context.MODE_PRIVATE);
    }

    public static void setSyncContanct(Boolean flag){
        getUserLogin(GlobalApplication.instance).edit().putBoolean(SYNC_KEY,flag).apply();
    }

    public static Boolean getSyncContact(){
        return getUserLogin(GlobalApplication.instance).getBoolean(SYNC_KEY, false);
    }
     ...
     * @param hiName
     */
    public static void cacheHospital(Context context,String hiId,String hiName){

        Editor edit = getHospitalSharedPreference(context).edit();
        edit.putString("hiId",hiId);
        edit.putString("hiName",hiName);
        edit.apply();
    }


    private static SharedPreferences getHospitalSharedPreference(Context context){

        return  context.getSharedPreferences("hospital", Context.MODE_PRIVATE);
    }
