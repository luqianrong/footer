...
import com.example.footer.view.GridAdapterCallback;
...
import static com.example.footer.R.id.pic;

/**
 * Created by 乃军 on 2018/1/8.
 */

public class FaBuActivity extends BaseActivity implements View.OnClickListener,UploadUtil.OnUploadProcessListener{
    ...
    public void gallery() {
       /* Intent intent = new Intent(
        ...
        //选择图片
        Intent intent=new Intent(FaBuActivity.this,SelectPicsActivity.class);
    ...
    private void pickImage() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN // Permission was added in API Level 16
            ...
            MultiImageSelector selector = MultiImageSelector.create(FaBuActivity.this);
            selector.showCamera(false);
            selector.count(maxNum);
            //多选
            selector.multi();
            selector.origin(mSelectPath);
            selector.start(FaBuActivity.this, REQUEST_IMAGE);
        }
    }
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(R.string.mis_permission_dialog_ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(FaBuActivity.this, new String[]{permission}, requestCode);
                        }
                    })
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == PHOTO_REQUEST_GALLERY) {
                ...
                if(resultCode == RESULT_OK){
                    ...
                    LogUtil.e("图片的地址--1111-："+mSelectPath.toString());
                    for(String picdir:mSelectPath){

                        try {
                            uploadImage(picdir);
                            //加线程是因为压缩需要耗时，一张图片压缩完在走下一张的压缩
                            Thread.sleep(100);
    ...
    private void requestWritePermission(){
        if (ActivityCompat.checkSelfPermission(FaBuActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(FaBuActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
        }else if(ActivityCompat.checkSelfPermission(FaBuActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(FaBuActivity.this, new String[]{Manifest.permission.CAMERA},1);
        }
    }
    ...
    public void onEventMainThread(FirstEvent event) {
           ArrayList<String> pics=event.getList();
           LogUtil.e("图片数组："+pics.toString());
           for(String picdir:pics){
               uploadImage(picdir);
           }
    }*/
