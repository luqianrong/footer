...
public class NineGridFootAdapter extends BaseAdapter {
    ...
    public NineGridFootAdapter(Context context) {
        mContext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null || convertView.getTag() == null) {
            ...
            convertView = View.inflate(GlobalApplication.instance,R.layout.item_myfoot_view,null);
